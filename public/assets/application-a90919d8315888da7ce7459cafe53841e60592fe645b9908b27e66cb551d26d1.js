...
function pickhash(id){
  var hash_id = id;
   ...
   $.ajax({
      url: "/brown/pickhash/"+hash_id
     
      
    });
if (document.getElementById(id+"hash").className === "hash-button-small-mango"){
    document.getElementById(id+"hash").className = "hash-button-small-mellon";    
}
else if (document.getElementById(id+"hash").className === "hash-button-small"){
    document.getElementById(id+"hash").className = "hash-button-small-mango";    
}
else if (document.getElementById(id+"hash").className === "hash-button-small-mellon"){
    document.getElementById(id+"hash").className = "hash-button-small";    
}
